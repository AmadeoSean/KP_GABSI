...
<html lang="en">
    <head>
        ...
        <title>Dashboard - SB Pelatih</title>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="border border-dark border-opacity-25">
                              <a class="nav-link {{ Request::is('pelatih') || Request::is('pelatih/latihan/*')?'active':''}}" href={{ url('pelatih') }}>
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                              </a>
                            </div >
                            <div class="border border-dark border-top-0 border-opacity-25">
                              <a class="nav-link {{ Request::is('pelatih/daftar_atlet') || Request::is('pelatih/daftar_atlet/*')?'active':''}}" href={{ url('pelatih/daftar_atlet') }}>
                              <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Daftar Atlet
                              </a>
                            </div>
                            <div class="border border-dark border-top-0 border-opacity-25">
                                <a class="nav-link {{ Request::is('pelatih/daftar_kejuaraan')?'active':''}}" href={{ url('pelatih/daftar_kejuaraan') }}>
                                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                    Daftar Kejuaraan
                                </a>  
                            </div>  
                            <div class="border border-dark border-top-0 border-opacity-25">
                                <a class="nav-link {{ Request::is('pelatih/profile')?'active':''}}" href={{ url('pelatih/profile') }}>
                                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                    Profile
                                </a>  
                            </div>  
