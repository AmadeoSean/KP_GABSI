                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="border border-dark border-opacity-25">
                              <a class="nav-link {{ Route::is('pelatih.index')?'active':''}}" href={{ route('pelatih.index') }}>
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                              </a>
                            </div >
                            <div class="border border-dark border-top-0 border-opacity-25">
                              <a class="nav-link {{ Route::is('pelatih-daftar_atlet')?'active':''}}" href={{ route('pelatih-daftar_atlet') }}>
                              <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Daftar Atlet
                              </a>
                            </div>
