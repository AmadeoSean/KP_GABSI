...
<div class="modal-body">
    <form method="POST" action="{{ url('/atlet/latihan/detail_latihan/'.$jadwal_latihan_id.'/EditCatatanPartner'.'/'.$catatan->id) }}">
        @csrf
        ...
        <textarea id="catatan" name="isiCatatan" class="form-control mb-2" style="min-height: 13rem">{{ $catatan->catatan_partner }}</textarea>
